                        ...
                        <div class="card text-black" style="border-radius: 25px;">
                            <div class="card-body p-md-5">
                                ...
                                <form action="EmitirSaldoController" method="get">
                                    <button type="submit" class="btn btn-primary btn-lg" name="emitirSaldo"
                                        value="true">Emitir Saldo</button>
                                </form>
                                <% HttpSession sessao=request.getSession() ; Boolean showTable=(Boolean)
                                    sessao.getAttribute("mostraSaldo") ; if(showTable) { %>
                                    <section>
